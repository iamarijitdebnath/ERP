    ...
    <section class="bg-gray-50">
        <div class="mx-auto ">
            <div class="block md:flex justify-between mb-4 items-center">
                <h3 class="text-2xl font-medium font-sans">Departments</h3>
                ...
                <div class="block md:flex gap-2 items-center">
                    ...
                    <a
                        href="{{ route('hrms.department.create') }}"
            ...
            <div class="relative overflow-hidden bg-white border border-gray-200 sm:rounded-lg">
                ...
                {{-- <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500 ">
                        Showing {{ $departments->firstItem() }}-{{ $departments->lastItem() }} of {{ $departments->total() }} records
                    </span>
    ...
    <script>
        ...
        const printData = (data) => {
            ...
            $(`#data_table tbody tr`).each((index, elem) => {
                let editRoute = `{{ route('hrms.department.edit', ['department' => '@@@']) }}`;
                $(elem).click(() => {
                    if($(elem).data('id')) {
        ...
        const fetchData = (page = 1, q = null) => {
            ...
            $.ajax({
                url: "{{ route('hrms.department.index') }}",
                type: "GET",
                data: {
                    page: page,
                    q: q
                ...
                success: function(response) {
                    ...
                    printData(response.data.departments.data);
                    renderPagination(response.data.departments);
                },
                error: function(xhr) {
