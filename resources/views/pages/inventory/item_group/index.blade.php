    ...
    <section class="bg-gray-50">
        <div class="mx-auto ">
            <div class="block md:flex justify-between mb-4 items-center">
                <h3 class="text-2xl font-medium font-sans">Item Groups</h3>
                ...
                <div class="block md:flex gap-2 items-center">
                    ...
                    <a
                        href="{{ route('inventory.item-group.create') }}"
    ...
    <script>
        ...
        const printData = (data) => {
            ...
            $(`#data_table tbody tr`).each((index, elem) => {
                let editRoute = `{{ route('inventory.item-group.edit', ['itemGroup' => '@@@']) }}`;
                $(elem).click(() => {
                    if($(elem).data('id')) {
        ...
        const fetchData = (page = 1, q = null) => {
            ...
            $.ajax({
                url: "{{ route('inventory.item-group.index') }}",
                type: "GET",
                data: {
                    page: page,
                    q: q
                ...
                success: function(response) {
                    printData(response.data.itemGroups.data);
                    renderPagination(response.data.itemGroups);
                },
                error: function(xhr) {
