    ...
    <section class="bg-gray-50">
        <div class="mx-auto ">
            <div class="block md:flex justify-between mb-4 items-center">
                <h3 class="text-2xl font-medium font-sans">Units of Measurement</h3>
                ...
                <div class="block md:flex gap-2 items-center">
                    ...
                    <a
                        href="{{ route('inventory.uom.create') }}"
                    ...
                    <table id="data_table" class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-blue-100">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">SI Unit</th>
                            </tr>
                        </thead>
    ...
    <script>
        ...
        const printData = (data) => {
                ...
                data.map((row, index) => {
                    dataHtml += `
                        ...
                        >
                            ...
                            <td class="px-4 py-2">${row.si_unit}</td>
                        </tr>
                    `;
                });
            } else {
            ...
            $(`#data_table tbody tr`).each((index, elem) => {
                let editRoute = `{{ route('inventory.uom.edit', ['uom' => '@@@']) }}`;
                $(elem).click(() => {
                    if($(elem).data('id')) {
        ...
        const fetchData = (page = 1, q = null) => {
            ...
            $.ajax({
                ...
                success: function(response) {
                    printData(response.data.uoms.data);
                    renderPagination(response.data.uoms);
                },
                error: function(xhr) {
