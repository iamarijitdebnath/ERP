    ...
    <section class="bg-gray-50">
        <div class="mx-auto ">
            <div class="block md:flex justify-between mb-4 items-center">
                <h3 class="text-2xl font-medium font-sans">Warehouses</h3>
                ...
                <div class="block md:flex gap-2 items-center">
                    ...
                    <a
                        href="{{ route('inventory.warehouse.create') }}"
    ...
    <script>
        ...
        const printData = (data) => {
            ...
            $(`#data_table tbody tr`).each((index, elem) => {
                let editRoute = `{{ route('inventory.warehouse.edit', ['warehouse' => '@@@']) }}`;
                $(elem).click(() => {
                    if($(elem).data('id')) {
        ...
        const fetchData = (page = 1, q = null) => {
            ...
            $.ajax({
                ...
                success: function(response) {
                    printData(response.data.warehouses.data);
                    renderPagination(response.data.warehouses);
                },
                error: function(xhr) {
